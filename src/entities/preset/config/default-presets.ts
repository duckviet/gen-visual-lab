...
export const DEFAULT_APP_STATE: AppState = {
  ...
  shader: {
    ...
    voronoiEdgeSoftness: 0.004,
    voronoiGlowRadius: 0.03,
    voronoiGlowIntensity: 0.8,
    voronoiWarpStrength: 0.035,
    voronoiWarpScale: 5,
    voronoiThicknessVariation: 0.55,
    voronoiJunctionBoost: 0.55,
    voronoiContrast: 1.15,
  },
  text: {
    value: "SHAPE",
  ...
  },
  {
    ...
    state: {
      ...
      shader: {
        ...
        grain: 0,
        voronoiSiteCount: 80,
        voronoiEdgeWidth: 0.01,
        voronoiEdgeSoftness: 0.006,
        voronoiGlowRadius: 0.045,
        voronoiGlowIntensity: 0.95,
        voronoiWarpStrength: 0.045,
        voronoiWarpScale: 6,
        voronoiThicknessVariation: 0.65,
        voronoiJunctionBoost: 0.7,
        voronoiContrast: 1.25,
      },
    },
  },
  {
